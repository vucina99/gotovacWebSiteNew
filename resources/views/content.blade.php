    ...
    <div class="row gx-0">
        <div class="col-lg-8 text-center text-lg-start mb-2 mb-lg-0">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
                <small class="me-3 text-light"><i class="fa fa-map-marker-alt me-2"></i>Španskih boraca 24v, Beograd</small>
                <small class="text-light"><a href="mailto:advgotovac@gmail.com" class="text-light"><i class="fa fa-envelope-open me-2"></i>advgotovac@gmail.com</a></small>
            </div>
        </div>
        <div class="col-lg-4 text-center text-lg-end ">
            <div class="d-inline-flex align-items-center" style="height: 45px;">
            <small class="me-3 text-light"><a href="tel:0653338933" class="text-light"><i class="fa fa-mobile me-2"></i>+381 65-3338933</a></small>
                <small class="me-3 text-light" ><a href="tel:+381116906807" class="text-light"><i class="fa fa-phone-alt me-2"></i>+381116906807</a></small>
            </div>
        </div>
    </div>
</div>
...
<div class="container-fluid position-relative p-0">
    <nav class="navbar navbar-expand-lg navbar-dark px-5 py-1 py-lg-0">
        ...
        <button class="navbar-toggler pt-2" type="button" data-bs-toggle="collapse" data-bs-target="#navbarCollapse">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav ms-auto py-0">
                ...
                <a href="/#questions" class="nav-item nav-link">Questions</a>
                <a href="/#review" class="nav-item nav-link">Ocene</a>
...
{{--                    </div>--}}
{{--                </div>--}}
                <a href="/kontakt" class="nav-item nav-link me-4">Contact</a>
            </div>
            <div class="ms-0 ps-0">
                <div  class="nav-item nav-link ms-0 ps-0 border-0 d-flex">
                    <div>  <a href="/promeni-jezik/sr"> <img src="{{asset("img/rs.png")}}" alt="" class="h-100 w-100 mr-5"></a> </div>
                    <div class="ps-4"></div>
                    <div> <a href="/promeni-jezik/en"><img src="{{asset("img/en.png")}}" class="h-100 w-100" alt=""></a></div>
                </div>
            </div>
        </div>
        </div>
        ...
        <div class="container">
            <div class="row gx-5">
                <div class="col-lg-4 col-md-6 footer-about">
                    <div class="d-flex flex-column align-items-center justify-content-center pb-5 text-center h-100 blue-papir p-4">
                        <a href="index.html" class="navbar-brand ">
                            <img src="{{asset("img/logo/new-full-logo.png")}}" alt="" class="w-100">
                        </a>
                        <p class="mt-3 mb-4">Prijavite se na naš newsletter i budite u toku sa najnovijim pravnim vestima i savetima.
                             </p><br>
                        <form action="">
                            <div class="input-group">
                                <input type="text" class="form-control border-white p-3" placeholder="{{__("index.vas email")}}">
                    ...
                    <div class="row gx-5">
                        <div class="col-lg-4 col-md-12 pt-5 mb-5 drzavaInfo">
                            <div class="section-title section-title-sm position-relative pb-3 mb-4">
                                <h3 class="text-light mb-0 d-flex align-items-center">{{__("index.kontakt")}} <span class="place"> &nbsp; (SR)</span> </h3>
                            </div>
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5 drzavaInfo">
                            <div class="section-title section-title-sm position-relative pb-3 mb-4">
                                <h3 class="text-light mb-0 d-flex align-items-center">{{__("index.kontakt")}} <span class="place"> &nbsp; (RS)</span> </h3>
                            </div>
                            <div class="d-flex mb-2">
                                <i class="bi bi-geo-alt text-primary me-2"></i>
                        ...
                        <div class="col-lg-4 col-md-12 pt-0 pt-lg-5 mb-5 drzavaInfo">
                            ...
                            <div class="link-animated d-flex flex-column justify-content-start">
                                <a class="text-light mb-2" href="https://aks.org.rs/cir/" target="_blank" rel="nofollow"><i class="bi bi-arrow-right text-primary me-2"></i> {{__("index.advokatska komora")}} &nbsp; </a>
                                <a class="text-light mb-2"  target="_blank" href="https://akbgd.org.rs/" rel="nofollow"><i class="bi bi-arrow-right text-primary me-2"></i> {{__("index.advokatska komora bg")}} &nbsp; </a>
                                <a class="text-light mb-2" href="https://www.apr.gov.rs/%d0%bf%d0%be%d1%87%d0%b5%d1%82%d0%bd%d0%b0.3.html"><i class="bi bi-arrow-right text-primary me-2"></i>{{__("index.registri")}}</a>
                                <a class="text-light mb-2"  target="_blank" href="https://www.prvi.os.sud.rs/"><i class="bi bi-arrow-right text-primary me-2"></i>{{__("index.sud")}}</a>
            ...
            <div class="row justify-content-end">
                <div class="col-lg-8 col-md-6">
                    <div class="d-flex align-items-center justify-content-center" style="height: 75px;">
                        <p class="mb-0">&copy; <a class="text-white border-bottom" href="#">Gotovac & Saradnici</a>. All Rights Reserved.</p>
                    </div>
                </div>
            </div>
        </div>
